...
def rejection_random_sample_kernel(
    ...
    end_idx = tl.load(cu_num_draft_tokens_ptr + req_idx)
    num_draft_tokens = end_idx - start_idx
    # start_idx * vocab_size overflows int32; promote before the stride
    # multiply below (see draft_prob/target_prob).
...
def sample_recovered_tokens_kernel(
    ...
    # token_idx/req_idx * vocab_size overflows int32; promote before the
    # stride multiplies below.
